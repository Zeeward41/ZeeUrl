// export const API_BASE_URL = window._env_.VITE_BACKEND_API_URL || import.meta.env.VITE_BACKEND_API_URL
// export const WEB_SITE_URL = window._env_.VITE_FRONTEND_URL || import.meta.env.VITE_FRONTEND_URL
export const API_BASE_URL = import.meta.env.VITE_BACKEND_API_URL
export const WEB_SITE_URL = import.meta.env.VITE_FRONTEND_URL
